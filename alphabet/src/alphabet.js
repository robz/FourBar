var alphabet = (function () {
    var data = {
        ...
        quote: {"P1":{"x":0,"y":0},"P5":{"x":-1.6529260786178404,"y":-1.038371189976839},"a1":1.6039999999999992,"a2":4.110000000000001,"a3":4.582,"a4":2.122,"a5":4.036,"speed1":1,"speed2":2,"theta2_phase":2.1978187718727877,"theta3":4.810362854159893}
    };
    ...
    data.A.scale(.30).translate(1.0, .3);
    data.B.scale(.16).translate(-.5, .23);
    data.Q.scale(.14).translate(0.26, .5);
    data.R.scale(.16).translate(0.0, .1);
    data.S.scale(.23).translate(0.74, -.65);
